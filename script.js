...
navigator.mediaDevices.getUserMedia(videoConstraints)
    ...
    .catch(err => {
        ...
        // Danh sách các đường dẫn đến 4 ảnh trên máy tính (hoặc thư mục dự án)
        const imagePaths = [
            "img/IMG_3457.JPG",
            "img/IMG_3457.JPG",
            "img/IMG_3457.JPG",
...
// Tự động thêm các ảnh vào mảng capturedPhotos
        imagePaths.forEach((imagePath, index) => {
            ...
            img.onload = function () {
                ...
                // Lấy kích thước của ảnh để vẽ lên canvas
